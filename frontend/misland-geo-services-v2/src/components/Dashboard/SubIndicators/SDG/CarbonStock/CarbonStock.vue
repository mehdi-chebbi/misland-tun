            ...
            <div class="dashboard-form-menu" v-show="show_selection_form">
              ...
              <div class="dashboard-product-selections">
                ...
                <div class="" v-if="show_advance_selections">
                  ...
                  <q-select hide-dropdown-icon outlined dense v-model="soc_ref" behavior="menu" :options="soc_refs">
                    <template v-slot:append>
                      <q-icon name="keyboard_arrow_down" color="grey-6" />
                    </template>
                  </q-select>
...
export default {
  ...
  data() {
    return {
      ...
      soc_refs: ["2000", "2001", "2002"], // soc reference years
  ...
  methods: {
    ...
    processStatsSummary() {
      // summary for state
      this.summary_html = this.$t("summaries.carbon_Stock_Change", [
