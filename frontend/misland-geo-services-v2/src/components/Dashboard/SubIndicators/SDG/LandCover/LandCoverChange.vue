  ...
  <div class="chart-container q-my-lg">
    ...
    <div v-show="!request_pending">
      <div class="flex justify-between">
        <div class="indicator-chart-title">{{ getRenderedCustomGeometryData?.name }} Land cover change </div>
        <!---------------------------------------  chart actions ----------------------------------------->
          ...
          <div class="q-ma-xs cursor-pointer relative-position">
            ...
            <div class="dashboard-form-menu" v-show="show_selection_form">
              ...
              <div class="dashboard-product-selections">
                ...
                <div class="q-my-sm flex" style="flex-wrap: nowrap; gap:10px">
                  <!-- start year -->
                  <div class="col">
                    <div class="label q-py-sm">START YEAR</div>
                  ...
                  <!-- end year -->
                  <div class="col">
                    <div class="label q-py-sm">END YEAR</div>
...
export default {
  ...
  data() {
    return {
      ...
      start_year: 2000,
      end_year: 2015,
      indicator: { label: "Land Cover Change", value: "land_cover_change", colors },
  ...
  methods: {
    ...
    async submit() {
      try {
        ...
        const results = await requestAnalysis({ uri, payload, caller: 'landcoverchange', indicator: this.indicator, hide_loading_progress: true });// request analysis
    ...
    processStatsSummary() {
      // summary for state
      this.summary_html = this.$t("summaries.land_Cover_Change", [
