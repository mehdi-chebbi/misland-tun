  ...
  <div class="chart-container q-my-lg">
    ...
    <div v-show="!request_pending">
      <div class="flex justify-between">
        <div class="indicator-chart-title">{{ getRenderedCustomGeometryData?.name }} Conservation Practice </div>
        <!---------------------------------------  chart actions ----------------------------------------->
        <div class="chart-actions flex">
          ...
          <!-- link to information -->
          <div flat class="q-ma-xs cursor-pointer">
            <a href="https://misland.readthedocs.io/en/latest/Service/Calculate_erosion.html" target="_blank"
          ...
          <div class="q-ma-xs cursor-pointer relative-position">
            ...
            <div class="dashboard-form-menu" v-show="show_selection_form">
              ...
              <div class="dashboard-product-selections">
                ...
                <div class="q-my-sm">
                  <div class="label q-py-sm">WATER EROSION FACTORS</div>
...
export default {
  ...
  methods: {
    ...
    async fetchYears() {
      this.years = await fetchComputationYears("RUSLE");
    ...
    async submit() {
      try {
        ...
        const results = await requestAnalysis({ uri, payload, caller: 'rusle', indicator: this.indicator, hide_loading_progress: true });// request analysis
